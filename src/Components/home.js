    ...
    <div>
        <div className="">
            ...
            <div className="main">
                ...
                <br />
                <p className="homepage"> A place where you can <i>finally</i> share
                ...
                <p className=" homepage">  At Covid Cooperative, we can share our <i><b>true</b></i> feelings. Our posts
